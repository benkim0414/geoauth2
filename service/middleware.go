...
func (mw loggingMiddleware) PostClient(ctx context.Context, c *Client) (client *Client, err error) {
...
func (mw loggingMiddleware) GetClient(ctx context.Context, id string) (client *Client, err error) {
	defer func(begin time.Time) {
